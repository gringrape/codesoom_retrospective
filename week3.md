...
과제 수행시, 25 분 집중후 5 분 휴식 패턴으로 기분개선효과와 집중향상효과를 얻었습니다. 휴식할때, 영상매체없이 고립된 공간에서 멍때리기로 휴식했는데,
도움이 크게되었습니다. 특히, 휴식 중에는 업무생각은 다시 자리 앉았을때 해도 충분하다고 마인드 컨트롤을 한것이 좋았습니다. 
...
아웃풋을 중요하게 생각한다는 관점을 좀 더 일반적으로 적용해보고 싶습니다.
무언가를 학습할때, 어떤 아웃풋을 낼지 미리 생각을 정리한다면, 이것이 계획이 되고 전략이 될 것 같습니다.
실제로 학습한 다음에, 전략대로 되지 않는다면 내생각과 현실이 어떤 부분에서 달랐는지 평가하고 고칠 수 있는 계기가 될 것 같습니다.
코드숨이 지금 상태에서는 저에게 학교와 같은 곳이므로,
이곳에서 하는 일들 부터 이런식의 마이크로 회고를 기록해보려고 합니다.
